...
public class client extends JFrame {
	...
	//}
		...
		lblGestionclient.setForeground(new Color(0, 255, 255));
		...
		btnenregistrer.setBounds(129, 609, 111, 25);
	...
	////////////==================validation boutton supprimer====================///////////////
			...
			public void actionPerformed(ActionEvent e) {
				...
				if( id_client.trim().length()==0
					...
					try {
						dbc db =new dbc ();
						Connection con = db.db_connect();
						 PreparedStatement stmt = (PreparedStatement) con.prepareStatement("DELETE FROM client_s WHERE id_client=?");
		...
		btnsupprimer.setBounds(379, 609, 111, 25);
		...
		lblRechercher.setBackground(Color.BLACK);
		lblRechercher.setBounds(443, 68, 75, 16);
		contentPane.add(lblRechercher);
		
		
		JLabel lblNewLabel_1 = new JLabel("Crit\u00E8re");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_1.setBounds(701, 68, 56, 16);
	...
	//////////////////////////////////validation of combo/////////////////////////////////////////////	
		...
		btnmodifier.setBounds(669, 609, 104, 25);
		...
		txtSearch.setBounds(425, 88, 116, 22);
	...
	//////////////////////////////////////////////////////////////////////////	
		...
		comboBoxCriteria.setBounds(666, 88, 133, 22);
		contentPane.add(comboBoxCriteria);
		
		/////////////////////////////////////////////
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(319, 168, 493, 374);
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\Documents\\Eclipse\\SA2\\images\\client.jpg"));
		lblNewLabel.setBounds(0, -13, 907, 660);
