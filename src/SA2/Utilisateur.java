...
public class Utilisateur extends JFrame {
	...
	public Utilisateur() {
		...
		btnModifier.setBounds(93, 495, 97, 25);
		contentPane.add(btnModifier);
		
		JButton btnNouveau = new JButton("Nouveau");
		btnNouveau.setFont(new Font("Tahoma", Font.BOLD, 13));
		btnNouveau.setBackground(Color.CYAN);
		...
		btnActualiser.setBounds(732, 495, 105, 25);
		...
		lblPassword.setBounds(33, 408, 97, 16);
...
//				userStmt.setString(1, txtSearch.getText());
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\Documents\\Eclipse\\APP\\img\\55.jpg"));
